...
##graph2
plot(x=projectdata$Newdate,y=projectdata$Voltage,xlab="datetime",ylab="Voltage",type = "l")
...
##graph4
plot(x=projectdata$Newdate,y=projectdata$Global_reactive_power,xlab="datetime",ylab="Global_reactive_power",type = "l")
